...
{
    /// <inheritdoc />
    public partial class ReCreateWithIdentity : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GradeMembrii", x => new { x.IdGrad, x.MembruId });
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "5aa2aaff-fd82-4482-af94-384a727d50e3", null, "Admin", "ADMIN" },
                    { "d2186d4b-7305-4a20-8690-865e7ac8841e", null, "Member", "MEMBER" }
                });
